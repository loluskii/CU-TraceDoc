...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="pending.php"><em class="fa fa-clock-o">&nbsp;</em> Pending Requests</a></li>
						...
						<form id="new_request" class="form-horizontal" action="" method="post">
							<fieldset>
								...
								<label class="col-md-2 control-label" for="name">Form Name</label>
									<div class="col-md-9">
										<?php
											...
											array_pop ( $results );
										?>
										<select id="my-select" class="form-control" required name="form_name">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<select class="form-control" required id="role">
											...
											<option value="SPS Senate Officer">SPS Senate Officer</option>
                                ...
                                <div class="form-group">
									...
									<div class="col-md-9">
										<select class="form-control" required id="role_name">
								...
								<div class="form-group">
									<div class="col-md-11 widget-right">
										<button id="submit_req" type="submit" class="btn btn-primary btn-md pull-right">Send Request</button>
									</div>
								</div>
							</fieldset>
						</form>
           ...
           $(document).ready(function(){
			   ...
			   $('#new_request').submit(function(e){
				   ...
				   $('#reg').html("processing").attr("disabled",true); //changes the button text to PROCESSING...
					$.ajax({
						type: 'POST',
						url: '../assets/server/reg.php?action=newreq',
						data: {
							type: 1,
							form_name: form_name,
