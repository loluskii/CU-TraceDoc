...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="resolved.php"><em class="fa fa-check">&nbsp;</em> Resolved Requests</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Resolved Requests</li>
            </ol>
        </div>
        <!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Resolved Requests</h1>
            </div>
        </div>
        <!--/.row-->
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-hover table-striped table-bordered" id="requests">
